  ...
  <div class="rounded-2xl border overflow-hidden shadow-sm animate-fadeInUp transition-all duration-300 hover:shadow-md" style="background: white; border-color: #E8EEF7;">
    ...
    <div class="p-5 space-y-5">
      ...
      <button
        ...
        :class="!isValid ? 'bg-slate-50 text-slate-400 cursor-not-allowed border border-slate-200' : 'bg-[#4A8BDF] text-white hover:bg-[#3A6ABF] hover:shadow-[0_6px_20px_rgba(74,139,223,0.3)] active:scale-[0.98] border border-transparent'"
      >
