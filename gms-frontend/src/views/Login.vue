    ...
    <div class="login-center">
      ...
      <div class="login-card" :class="{ 'shake': shakeCard, 'card-loaded': mounted }">
        ...
        <form class="login-form" @submit.prevent="handleLogin" id="login-form">
          <!-- Username -->
          <div class="field" :class="{ 'field-active': focusUser || formData.username }">
            ...
            <div class="field-input-wrap">
              <label for="input-username" class="field-label">Username</label>
              <input
                id="input-username"
...
const handleLogin = () => {
  ...
  setTimeout(() => {
    ...
    if (result.success) {
      ...
      statusIcon.value = '✅'
      notificationStore.addNotification('Login Success', `Selamat datang kembali, ${authStore.user.name}!`, 'success')
      ...
      notificationStore.addNotification('Login Failed', result.message, 'error')
