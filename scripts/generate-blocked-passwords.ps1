...
[void]$Sb.Append("// ==============================================================================`n")
[void]$Sb.Append("// GMS Enterprise Blocked Passwords Dataset v1.1`n")
...
[void]$Sb.Append("const ENCODED_BLOCKLIST =`n  '$Base64Payload';`n`n")
...
[void]$Sb.Append("}`n`n")
[void]$Sb.Append("export const BLOCKED_PASSWORDS_SET: ReadonlySet<string> =`n  loadBlockedPasswords();`n`n")
