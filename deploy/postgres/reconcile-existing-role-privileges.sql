...
BEGIN
  ...
  -- 14. Explicitly revoke UPDATE, DELETE, and TRUNCATE on immutable audit and history tables for gms_app
  FOR r IN (
  ...
  -- 15. Explicitly revoke DELETE and TRUNCATE on Transaction for gms_app (Zero Hard-Delete architecture)
